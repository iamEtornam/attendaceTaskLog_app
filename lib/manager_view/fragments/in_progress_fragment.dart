...
class InProgressFragment extends StatefulWidget {
  final String employee;

  const InProgressFragment({Key key, this.employee}) : super(key: key);

  @override
  _InProgressFragmentState createState() => _InProgressFragmentState();
}

class _InProgressFragmentState extends State<InProgressFragment> {
  @override
